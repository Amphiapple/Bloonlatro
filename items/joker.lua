...
SMODS.Joker { --Draft
	...
	order = 221,
	blueprint_compat = true,
    config = { extra = { hands = 1, counter = 0 } }, --Variables: hands = extra hands, scored_chips = chips for first hands, current = amount of blowback hands left
