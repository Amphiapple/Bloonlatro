return {
    descriptions = {
        ...
        Power = {
            ...
            c_bloons_portable_lake = {
                name = 'Portable Lake',
                text = {
                    '{C:dark_edition}#1#{}#2#{C:inactive}#3#{}'
                }
            },
            c_bloons_road_spikes = {
                name = 'Road Spikes',
                text = {
