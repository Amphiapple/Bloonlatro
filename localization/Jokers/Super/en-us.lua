return {
	descriptions = {
		Joker = {
			j_bloons_super_monkey = {
				name = 'Super Monkey',
				text = {
					'{C:mult}+#1#{} Mult',
				}
			},
			j_bloons_laser_blasts = {
				name = 'Laser Blasts',
				text = {
					'{C:mult}+#1#{} Mult',
				}
			},
			j_bloons_plasma_blasts = {
				name = 'Plasma Blasts',
				text = {
			...
			j_bloons_sun_temple = {
				name = 'Sun Temple',
				text = {
					'Sacrifice adjacent {C:attention}Jokers{} once',
