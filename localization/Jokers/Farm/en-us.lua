return {
	descriptions = {
		Joker = {
            ...
            j_bloons_banana_salvage = {
                name = 'Banana Salvage',
                text = {
                    'All cards sell for {C:money}$#1#{} more'
                }
            },
            j_bloons_marketplace = {
                name = 'Marketplace',
                text = {
