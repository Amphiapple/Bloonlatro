return {
	descriptions = {
		Joker = {
			...
			j_bloons_monkey_intelligence_bureau = {
			...
			j_bloons_monkey_commerce = {
				name = 'Monkey Commerce',
				text = {
					'Shop items cost {C:attention}#1#%{} less',
				}
			},
			j_bloons_monkey_town = {
				name = 'Monkey Town',
				text = {
